...
<div class="max-w-4xl">
    ...
    <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data" class="mt-6 space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        @csrf
